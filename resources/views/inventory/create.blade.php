...
<div class="max-w-3xl mx-auto">
    ...
    <h2 class="text-3xl font-bold text-blue-700 mb-8">Ajouter une poche de sang</h2>
        ...
        <form action="{{ route('inventory.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="blood_type"
                        class="w-full px-4 py-2 border rounded-lg bg-white shadow-sm focus:ring-blue-500 focus:border-blue-500">
